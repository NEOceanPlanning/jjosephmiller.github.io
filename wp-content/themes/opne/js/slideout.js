        ...
        app.init = function() {
            ...
            app.closeNav =function() {
                if(nav_open) {
                    ...
                    if(duration > 0) document.addEventListener(transition_end, closeNavEnd, false);
            ...
            app.toggleNav = function(e) {
                if(nav_open && hasClass(doc, nav_class)) app.closeNav();
                else app.openNav();
            ...
            document.addEventListener('click', function(e) {
                if(nav_open && !hasParent(e.target, 'slideout')) {
                    e.preventDefault();
                    app.closeNav();
                }
            },
